          ...
          <div className="grid grid-cols-[10%_1fr_10%] lg:grid-cols-[15%_1fr_5%]">
            ...
            <div className="min-h-screen mx-auto max-w-[80ch]">
              <section className="mt-10 mb-32">
                ...
                <div className="flex flex-col gap-8 text-xl md:text-2xl font-medium leading-normal">
                  <p>
                    ...
                    company specializes in programming solutions for the payment
                    industry, particularly for events and the restaurant
                    industry. They have also developed auxiliary systems to help
                    streamline and organize volunteers involved in these events,
                    from planning to post-event cleanup, all in one centralized
                    platform.
                  </p>
                  <p>
                    In recent years, Heimdal Data ApS has expanded its services
                    to include app development and mobile games. Their most
                    notable achievement is the game &#34;Slette Mette&#34;,
                    released in 2021, which gained significant popularity and
                    ranked as the number one most downloaded free game in the
                    categories of All Free Games and Arcade on Google Play, as
                    well as All Free Games and Action on the AppStore.
                  </p>
                </div>
              </section>
              ...
              >
                ...
                <p className="mb-8">
                  In-depth research will be conducted to gain insights into the
                  target audience, competitors, and industry trends. This will
                  involve:
                </p>
              ...
              >
                ...
                <p className="mb-16">
                  ...
                  relationships between different content elements. Low-fidelity
                  wireframes will be created using tools such as Figma,
                  outlining the website&#39;s layout and content placement.
                </p>
                <Wireframes />
              </TrackedSection>
              ...
              >
                ...
                <p className="mb-16">
                  ...
                  appealing and cohesive UI design that aligns with Heimdal Data
                  ApS&#39;s brand identity. This will include:
                </p>
              ...
              >
                ...
                <p className="mb-16">
                  ...
                  identify areas for improvement. This iterative testing process
                  will help refine the UX and UI elements, ensuring a seamless
                  user experience.
                </p>
                <SinglePicture
              ...
              >
                ...
                <p className="mb-16">
                  ...
                  The website will be implemented using WordPress, ensuring easy
